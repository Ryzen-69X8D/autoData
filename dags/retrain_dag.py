...
def _should_deploy(**context):
    ...
    # ── FIX: Match the exact file name generated by src/evaluate.py ──
    new_metrics_path      = "/opt/airflow/models/eval_metrics.json" 
    deployed_metrics_path = "/opt/airflow/models/metrics_deployed.json"

    # If this is the very first time running, deploy it unconditionally
    ...
    # ── LOGIC: strictly deploy ONLY if the new RMSE is lower ──
